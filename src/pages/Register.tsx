...
export default function Register() {
  ...
  return (
    <SiteLayout>
      <div className="min-h-screen flex flex-col md:flex-row bg-background pt-20">
          ...
          >
            ...
            <div className="space-y-3">
              <Button 
                variant="outline" 
                type="button" 
                className="w-full h-12 bg-white text-black border-slate-200 rounded-xl flex items-center justify-center gap-3 hover:bg-slate-50 transition-all shadow-sm"
                onClick={() => handleSocialLogin("Google (Gmail)")}
              >
                <FaGoogle className="h-5 w-5 text-[#DB4437]" />
                <span className="text-sm font-bold">التسجيل بواسطة Google (Gmail)</span>
              </Button>

              <Button 
                variant="outline" 
                type="button" 
                className="w-full h-12 bg-black text-white border-none rounded-xl flex items-center justify-center gap-3 hover:bg-black/90 transition-all shadow-sm"
                onClick={() => handleSocialLogin("Apple")}
              >
                <FaApple className="h-6 w-6" />
                <span className="text-sm font-bold">التسجيل بواسطة Apple</span>
              </Button>

              <Button 
                variant="outline" 
                type="button" 
                className="w-full h-12 bg-[#1877F2] text-white border-none rounded-xl flex items-center justify-center gap-3 hover:bg-[#166fe5] transition-all shadow-sm"
                onClick={() => handleSocialLogin("Facebook")}
              >
                <FaFacebook className="h-5 w-5" />
                <span className="text-sm font-bold">التسجيل بواسطة Facebook</span>
              </Button>
            </div>
